      ...
      <section className="rounded-2xl border border-border bg-card/60 p-5">
        ...
        <div className="space-y-3 text-sm">
          <div className="rounded-xl bg-muted p-3">
            <code className="font-bold text-foreground">COMING-SOON</code>
            <p className="mt-1 text-muted-foreground">No active codes currently available</p>
          </div>
          <div className="rounded-xl bg-muted p-3">
            <code className="font-bold text-foreground">STAY-TUNED</code>
            <p className="mt-1 text-muted-foreground">Check back soon for new codes</p>
          </div>
